...
function Search() {
  ...
  // MOVIES TO SHOW
  const displayMovies =
    query.length > 2 ? results : defaultMovies;
  ...
  const handleMouseEnter = (e, movie) => {
    ...
    if (top + cardHeight > scrollBottom) {
      top =
        scrollBottom - cardHeight - 20;
    }
        ...
        createPortal(
          ...
          >
            ...
            <div className="p-4">
              ...
              >
                <span>
                  {hoverMovie.release_date?.split(
                    "-"
                  )[0] ||
                    hoverMovie.first_air_date?.split(
                      "-"
                    )[0]}
                </span>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>
                    {hoverMovie.vote_average?.toFixed(
                      1
                    )}
                  </span>
                </div>
